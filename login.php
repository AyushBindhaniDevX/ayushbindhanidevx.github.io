...
<head>
  ...
  <title>KIMUN OC Dashboard</title>
      ...
      <div class="col-lg-5">
        ...
        <div class="form-wrap border rounded p-4">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            <div class="mb-3">
              <label for="user_login" class="form-label">Full Name</label>
            ...
            <div class="mb-2">
              ...
              <input type="date" class="form-control" name="user_password" id="password">
          ...
          </form><br><br><a href="./co-sponsorindex.php" class="btn btn-warning">Apply for Collaboration/ Sponsorship</a><br><br><a href="https://eb.mun.42web.io/" class="btn btn-info">Executive Board Dashboard</a>
